...
End-to-end machine maintenance and reliability analytics project combining Python, PostgreSQL, SQL, Excel, and Power BI to explore machine failures, maintenance strategies, equipment health, and telemetry patterns.

### Project Highlights

**100 Machines** · **761 Failure Incidents** · **3,286 Maintenance Records** · **98% Assets with Recorded Failure**

`Python` `Pandas` `PostgreSQL` `SQL` `Excel` `Power BI` `DAX` `Data Modeling`
...
The project follows a multi-stage data preparation and validation workflow before visualization in Power BI.

Key preparation steps included:

- Downloaded the Microsoft Azure Predictive Maintenance dataset from Kaggle and organized the source files as raw data.
- Used **Python and Pandas** to inspect, clean, transform, and prepare machine, telemetry, failure, maintenance, and error data.
- Performed exploratory data analysis in **Jupyter Notebook** to investigate failure patterns, maintenance activity, machine age, component behavior, and time-based trends.
- Loaded structured data into **PostgreSQL** and used SQL queries for data validation, aggregation, and analytical exploration.
- Created processed analytical datasets, including machine-level summaries, monthly summaries, and data-quality reports.
- Used **Excel** as an additional data-audit layer to review and validate prepared analytical outputs.
- Built a dedicated **DateTable** and shared **Components** dimension in Power BI to support consistent time-based and component-level analysis.
- Established one-to-many relationships between dimension and fact tables using machine ID, date, and component keys.
- Created a dedicated **_Measures** table to organize DAX measures and analytical KPIs.
- Validated data coverage before interpreting trends, including identifying January 2016 as a partial telemetry period.
...
- **Python & Pandas** — data cleaning, transformation, exploratory analysis, and analytical dataset preparation
- **Jupyter Notebook** — exploratory data analysis and investigation of failure, maintenance, and machine patterns
- **PostgreSQL & SQL** — relational data storage, validation, aggregation, and analytical querying
- **pgAdmin** — PostgreSQL database management and query execution
- **Microsoft Excel** — additional data auditing and validation of analytical outputs
...
- **Power BI Desktop** — data modeling, interactive dashboard development, and visualization
- **Git & GitHub** — version control, project documentation, and portfolio publishing